...
if ( ! class_exists( 'jackdaniels_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	 * @since jackdaniels 1.0
	 */
	class jackdaniels_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'jackdaniels' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'jackdaniels' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'jackdaniels' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'jackdaniels' ),
						'full'    => esc_html__( 'Full text', 'jackdaniels' ),
					),
				)
			);
			...
			include_once get_theme_file_path( 'classes/class-jackdaniels-customize-color-control.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound

			// Register the custom control.
			$wp_customize->register_control_type( 'jackdaniels_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new jackdaniels_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'jackdaniels' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
